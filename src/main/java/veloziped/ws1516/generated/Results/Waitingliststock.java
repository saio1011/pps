 ...
 *       &lt;sequence>
 *         &lt;element ref="{}missingpart" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "waitingliststock")
public class Waitingliststock {

    @XmlElement(required = true)
    protected List<Missingpart> missingpart;
     ...
     * 
     */
    public List<Missingpart> getMissingpart() {
        if (missingpart == null) {
            missingpart = new ArrayList<Missingpart>();
        }
